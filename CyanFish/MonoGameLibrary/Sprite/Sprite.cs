...
namespace MonoGameLibrary.Sprite
{
    ...
    public class Sprite : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public Vector2 Location, Direction, Origin, GravityDir;  //Origin starts at top left can be moved to center by uncommenting code in LoadContent
        public float Speed, GravityAccel; 
